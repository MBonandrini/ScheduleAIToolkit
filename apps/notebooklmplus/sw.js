const CACHE = 'notebooklmplus-v0.7.4-suite-globalai';
const SHELL = [
  './', './index.html', './css/styles.css?v=0.7.4-suite-globalai', './manifest.webmanifest',
  './js/app.js?v=0.7.4-suite-globalai', './js/config.js', './js/db.js', './js/utils.js', './js/progress.js',
