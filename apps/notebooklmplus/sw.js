const CACHE = 'notebooklmplus-v0.7.3-suite';
const SHELL = [
  './', './index.html', './css/styles.css?v=0.7.3-suite', './manifest.webmanifest',
  './js/app.js?v=0.7.3-suite', './js/config.js', './js/db.js', './js/utils.js', './js/progress.js',
