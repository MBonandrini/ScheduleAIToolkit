...
async function runAI(messages,options={}){
    ...
    if(
        ...
        try{
            ...
            console.warn(
                "MLC inference failed. Switching to CPU.",
                error
            );
