...
const TOOL_CONFIG = {
    contracts: { name: "Contract Manager", url: "./apps/contract-manager/index.html?sharedPane=1&v=20260903-airuntime-controls1" },
    drawing: { name: "Drawing Measurement", url: "./apps/drawing-measurement/index.html?sharedPane=1&v=20260903-airuntime-controls1" },
    assessment: { name: "Schedule Assessment", url: "./apps/schedule-assessment/index.html?sharedPane=1&v=20260903-airuntime-controls1" },
    risk: { name: "Risk Analysis", url: "./apps/risk-analysis/index.html?sharedPane=1&v=20260903-airuntime-controls1" },
    claims: { name: "Claims & Forensics", url: "./apps/claims-forensics/index.html?sharedPane=1&v=20260903-airuntime-controls1" },
    notebook: { name: "NotebookLM+", url: "./apps/notebooklmplus/index.html?v=20260903-airuntime-controls1" },
    settings: { name: "Settings", url: "./apps/settings/index.html?v=20260903-airuntime-controls1" },
    builder: { name: "Schedule Builder", url: "./apps/schedule-builder/index.html?v=20260903-airuntime-controls1" }
};
