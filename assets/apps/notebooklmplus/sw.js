const CACHE = 'notebooklmplus-v0.8.3-suite-ui-cleanup';
const SHELL = [
  './', './index.html', './css/styles.css?v=0.8.3-suite-ui-cleanup', './manifest.webmanifest',
  './js/app.js?v=0.8.3-suite-ui-cleanup', './js/config.js', './js/db.js', './js/utils.js', './js/progress.js',
