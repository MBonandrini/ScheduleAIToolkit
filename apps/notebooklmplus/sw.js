const CACHE = 'notebooklmplus-v0.7.2-suite';
const SHELL = [
  './', './index.html', './css/styles.css?v=0.7.2-suite', './manifest.webmanifest',
  './js/app.js?v=0.7.2-suite', './js/config.js', './js/db.js', './js/utils.js', './js/progress.js',
