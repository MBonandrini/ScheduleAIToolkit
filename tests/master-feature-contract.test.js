...
export async function run(){
  ...
  const requirements=[
    ...
    ["forensic review",app.includes("Forensic Review · up to 10 schedules")],
    ...
    ["baseline/lookahead",app.includes("Finish variance")&&app.includes("Next four weeks · detailed by WBS")],
    ["nodes",app.includes("Nodes")&&!app.includes("Nodes & Links")],
    ["readonly global AI display",(html.match(/id="aiDisplay"/g)||[]).length===1&&(html.match(/id="aiSelect"/g)||[]).length===0&&app.includes("settingsAiSelect")],
