...
function generalView() {
  ...
  return `<div class="grid">
    ...
    <section class="card wide"><div class="card-head">NotebookLM+ advanced configuration</div><div class="card-body">
      ...
      </div><div class="actions"><label><input id="nbSemantic" type="checkbox" ${n.semanticSearch!==false?'checked':''}> Semantic/vector retrieval when embeddings are available</label><label><input id="nbKeyword" type="checkbox" ${n.keywordSearch!==false?'checked':''}> Keyword retrieval</label></div>`})()}
      <div class="note">These are the advanced controls that were on the original NotebookLM+ configuration page. They apply to NotebookLM+ only; the AI provider/model remains globally controlled above.</div>
