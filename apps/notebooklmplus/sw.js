const CACHE = 'notebooklmplus-v0.7.5-suite-airuntime';
const SHELL = [
  './', './index.html', './css/styles.css?v=0.7.5-suite-airuntime', './manifest.webmanifest',
  './js/app.js?v=0.7.5-suite-airuntime', './js/config.js', './js/db.js', './js/utils.js', './js/progress.js',
