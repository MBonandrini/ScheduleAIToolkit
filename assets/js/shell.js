...
const TOOL_CONFIG = {
    contracts: { name: "Contract Manager", url: "./apps/contract-manager/index.html?sharedPane=1&v=20260908-central-ai-context-clean2" },
    drawing: { name: "Drawing Measurement", url: "./apps/drawing-measurement/index.html?sharedPane=1&v=20260908-central-ai-context-clean2" },
    assessment: { name: "Schedule Assessment", url: "./apps/schedule-assessment/index.html?sharedPane=1&v=20260908-central-ai-context-clean2" },
    risk: { name: "Risk Analysis", url: "./apps/risk-analysis/index.html?sharedPane=1&v=20260908-central-ai-context-clean2" },
    claims: { name: "Claims & Forensics", url: "./apps/claims-forensics/index.html?sharedPane=1&v=20260908-central-ai-context-clean2" },
    notebook: { name: "NotebookLM+", url: "./apps/notebooklmplus/index.html?v=20260908-central-ai-context-clean2" },
    settings: { name: "Settings", url: "./apps/settings/index.html?v=20260908-central-ai-context-clean2" },
    builder: { name: "Schedule Builder", url: "./apps/schedule-builder/index.html?v=20260908-central-ai-context-clean2" }
};
